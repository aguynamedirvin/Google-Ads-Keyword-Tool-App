            ...
            <div class="p-4">
                <div class="grid grid-cols-2 gap-4 md:gap-6 md:grid-cols-3">
                    ...
                    <div class="flex flex-col justify-between bg-yellow-100 p-6 rounded-lg overflow-hidden">
                        ...
                        <p class="text-4xl font-bold text-yellow-800">$<?= isset($metrics['avgCostPerConversion']) ? $metrics['avgCostPerConversion'] : '--.--'?></p>
                    </div>
                    ...
                    <div class="flex flex-col justify-between bg-violet-100 p-6 rounded-lg overflow-hidden">
                        ...
                        <p class="text-4xl font-bold text-violet-800"><?= isset($metrics['totalImpressions']) ? $metrics['avgCostPerConversion'] : '--.--'?></p>
                    </div>
                    <div class="flex flex-col justify-between bg-neutral-100 p-6 rounded-lg overflow-hidden">
                        ...
                        <p class="text-4xl font-bold text-neutral-800"><?= isset($metrics['avgConversionRate']) ? $metrics['avgConversionRate'] : '--.--'?>%</p>
                    </div>
                <div>
            </div>
