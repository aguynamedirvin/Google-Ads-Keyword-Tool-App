...
<header id="header" class="bg-white p-5 border-b border-slate-100 shadow-sm dark:border-slate-700 dark:bg-slate-900">
    <div id="app-header-nav" class="container flex flex-row mx-auto justify-between gap-6">
